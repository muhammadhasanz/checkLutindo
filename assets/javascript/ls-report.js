                ...
                return $('#myReport').DataTable({
                    ...
                    columnDefs: [{
                        ...
                        render: function render(data, type, row, meta) {
                            if (data == 'Telah diterima') {
                                return "<span class=\"badge badge-subtle badge-success\">Telah diterima</span";
                            } else {
                                return "<span class=\"badge badge-subtle badge-warning\">Proses pengirima</span";
                            }
                        }
                    }, {
                    }]
